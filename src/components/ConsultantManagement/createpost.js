  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <div style={{ display: 'inline-block', textAlign: 'left', border: '1px solid #ccc', padding: '20px', borderRadius: '10px', backgroundColor: '#fff', width: '700px', marginLeft: '100px', marginBottom: '20px' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <button style={{ marginRight: '5px', backgroundColor: 'blue', color: '#fff', padding: '10px 20px', border: 'none', borderRadius: '5px' }} onClick={handlePost}>Post</button>
          <button style={{ marginLeft: '5px', backgroundColor: 'red', color: '#fff', padding: '10px 20px', border: 'none', borderRadius: '5px' }} onClick={handleCancel}>Cancel</button>
        </div>
      </div>
    </div>
  );
