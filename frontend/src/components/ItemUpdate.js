...
//           Image: response.data.stock.Image
//         });
//       })
//       .catch((error) => {
//         console.error(error);
...
//     try {
//       let imageUrl = formData.Image; // Keep the existing image URL if no new image is selected
...
//         imageUrl = response.data.imageUrl; // Get the URL of the uploaded image
//       }
...
//       await axios.put(`http://localhost:8070/business/update/${uniqueKey}`, updatedFormData);
